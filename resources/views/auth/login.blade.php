                                    ...
                                    <form action="{{ route('login.authenticate') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control @error('email') is-invalid @enderror"
                                                name="email" value="{{ old('email') }}" placeholder="Entrez votre adresse email valide" required autofocus>
                                            @error('email')
                                        ...
                                        <div class="new-account mt-3 text-center">
                                            <p>Vous n'avez pas de compte? <a class="text-primary" href="{{ route('entreprise.addEntreprise') }}">Inscrivez-vous</a></p>
                                        </div>
                                    </form>
